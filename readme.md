...
```js
import imagemin, {gifsicle, mozjpeg, optipng, svgo, webp} from 'gulp-imagemin';
...
- [webp](https://github.com/imagemin/imagemin-webp) — *Compress WEBP images, lossy or lossless*
...
Type: `Array`\
Default: `[gifsicle(), mozjpeg(), optipng(), svgo(), webp()]`
